...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabLogin = __webpack_require__(274);
	var TabView = __webpack_require__(276);
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(
	    'h1',
	    null,
	    'app.jsx server exploration App!'
	  ),
	  React.createElement(
	    Router,
	    { history: hashHistory },
	    React.createElement(
	      Route,
	      { path: '/', component: Main },
	      React.createElement(Route, { path: 'tabview', component: TabView }),
	      React.createElement(IndexRoute, { component: TabLogin })
	    )
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Users = __webpack_require__(247);
	...
	var Nav = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        IndexLink,
	        { to: '/', testProp: 'dsafsad', params: { testvalue: "hello" }, activeClassName: 'active', activeStyle: { fontWeight: 'bold' } },
	        'Login'
	      ),
	      React.createElement(
	        Link,
	        { to: '/tabView', testProp: 'dsafsad', params: { testvalue: "hello" }, activeClassName: 'active', activeStyle: { fontWeight: 'bold' } },
	        'View'
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsersReducer = __webpack_require__(246);
...
/***/ function(module, exports) {
	...
	var usersDefaultState = {
	  user: '',
	  userList: []
	};

	module.exports = {
	  usersReducer: function usersReducer() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : usersDefaultState;
	    var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Redux = __webpack_require__(224);
	var UserLogin = __webpack_require__(248);
	...
	function logoutUser() {
	  ...
	  UserLogin.sendLogout(user).then(function (res) {
	...
	function updateUserList() {
	  ...
	  UserLogin.getUsers().then(function (u) {
	    users = u.slice();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  sendLoginChoice: function sendLoginChoice(data) {
	  ...
	  sendLogout: function sendLogout(username) {
	    var data = { username: username };
	    return axios.post('/api/logout', data).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var UserLoginList = __webpack_require__(275);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var UserLogin = __webpack_require__(248);
	var ListItem = __webpack_require__(280);
	var Users = __webpack_require__(247);
	var Redux = __webpack_require__(224);
	...
	var UserLoginList = function (_React$Component) {
	  ...
	  function UserLoginList(props) {
	    ...
	    Redux.subscribe(function () {
	      ...
	      var tmp = _this.state.message;
	      _this.setMessage('refresh');
	      _this.setMessage(tmp);
	    });
	  ...
	  _createClass(UserLoginList, [{
	    key: 'setSelectedUser',
	    value: function setSelectedUser(username) {
	    ...
	    value: function handleSubmit(event) {
	      ...
	      var formData = { user: this.state.selectedUser };
	      var tempThis = this;

	      UserLogin.sendLoginChoice(formData).then(function (response) {
	    ...
	    value: function render() {
	      ...
	      if (userList !== undefined) {
	        printOut = userList.map(function (username) {
	          return React.createElement(ListItem, {
	            key: userItemId++,
	            content: username,
	            onClickParentHandler: _this2.onItemClick.bind(_this2),
	            isSelected: _this2.state.selectedUser === username ? true : false
	          });
	        });
	      }
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { type: 'submit', className: 'btn btn-default', disabled: !this.isUserSelected() || Users.isUserLoggedIn() },
	            'Login'
	          )
	        ),
	        React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var UserInventory = __webpack_require__(277);
	var UserList = __webpack_require__(278);
	var ServerInventory = __webpack_require__(279);
