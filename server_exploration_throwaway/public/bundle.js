...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabLogin = __webpack_require__(224);
	var TabView = __webpack_require__(253);

	var redux = __webpack_require__(257);
	...
	var Nav = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        Link,
	        { to: '/tabView', activeClassName: 'active', activeStyle: { fontWeight: 'bold' } },
	        'View'
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var UserLoginList = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListItem = __webpack_require__(252);
	...
	var UserLoginList = function (_React$Component) {
	  ...
	  function UserLoginList(props) {
	    ...
	    UserLogin.getUsers().then(function (users) {
	      tempThis.setState(_extends({}, tempThis.state, {
	        userList: users
	      }));
	  ...
	  _createClass(UserLoginList, [{
	    ...
	    value: function handleSubmit(event) {
	      ...
	      var formData = { user: this.state.user };
	      var tempThis = this;
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          this.state.userList.map(function (username) {
	          ...
	          React.createElement(
	            'button',
	            { type: 'submit', className: 'btn btn-default', disabled: !this.state.userSelected || this.state.userLoggedIn },
	            'Login'
	          )
	        ),
	        React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var UserInventory = __webpack_require__(254);
	var UserList = __webpack_require__(255);
	var ServerInventory = __webpack_require__(256);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nameReducer = function nameReducer() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'DefaultName';
	  var action = arguments[1];
