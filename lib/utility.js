...
function assert(a, msg){
  if(a == null || a == undefined || a == ''){
    throw new Error("assert : " + a + " : is undefined : " + msg);
  }
}
...
//SWITCH THESE TO ENABLE AND DISABLE LOGGING
let LOG_VERBOSE = true; //for general logging or debugging
let WARNING_VERBOSE = true; //for warnings
let ERROR_VERBOSE = true; //for errors

function logWarning(){
  if(console && WARNING_VERBOSE){
