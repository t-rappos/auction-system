...
function getAllListings(){
    ...
    return getListingModel().findAll({where:{expiry_date :{$gt:new Date()},expiry_processed:false }, include: [getItemModel()]});
}
...
function getExpiredListings(){
    return getListingModel().findAll({where:{expiry_date :{$lte:new Date()},expiry_processed:false }});
}

function getAccountListings(accountId){
    return getListingModel().findAll({where:{sellerId : accountId,expiry_processed:false},include: [getItemModel()]});
}
