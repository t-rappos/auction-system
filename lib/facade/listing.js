...
function getAllListings(){
    ...
    return getListingModel().findAll({where:{expiry_date :{$gt:new Date()},expiry_processed:false,sold:false }, include: [getItemModel()]});
}
...
function getAccountListings(accountId){
    return getListingModel().findAll({where:{sellerId : accountId,expiry_processed:false, sold:false},include: [getItemModel()]});
}
